...
export const AuthModal: React.FC<AuthModalProps> = ({ onSuccess, initialMode = 'login' }) => {
  ...
  const [college, setCollege] = useState('GH Raisoni College of Engineering and Management (GHRCEMN)');
      ...
      if (data.user) {
        ...
        if (!profile) {
          ...
          const fallbackProfile: Profile = {
            ...
            college: meta.college || 'GH Raisoni College of Engineering and Management (GHRCEMN)',
          ...
          <form onSubmit={handleSignup} className="space-y-3 max-h-[72vh] overflow-y-auto pr-1">
            ...
            <div>
              ...
              <select
                ...
                className="w-full px-3 py-2 bg-slate-950 border border-slate-800 rounded-xl text-xs text-white focus:outline-none focus:border-indigo-500"
              >
                <option value="GH Raisoni College of Engineering and Management (GHRCEMN)">GH Raisoni College of Engineering & Management (GHRCEMN)</option>
